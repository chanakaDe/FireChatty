(function () {
    ...
    fb.simplelogin.util.json.eval = function (a) {
    ...
    fb.simplelogin.Transport.prototype.open = function () {
    };
    fb.simplelogin.transports.Popup = {};
    fb.simplelogin.Popup = function () {
    };
    fb.simplelogin.Popup.prototype.open = function () {
    };
    fb.simplelogin.util.misc = {};
    fb.simplelogin.util.misc.parseUrl = function (a) {
        var b = document.createElement("a");
        b.href = a;
        return{protocol: b.protocol.replace(":", ""), host: b.hostname, port: b.port, query: b.search, params: fb.simplelogin.util.misc.parseQuerystring(b.search), hash: b.hash.replace("#", ""), path: b.pathname.replace(/^([^\/])/, "/$1")}
    };
    fb.simplelogin.util.misc.parseQuerystring = function (a) {
        for (var b = {}, a = a.replace(/^\?/, "").split("&"), c = 0; c < a.length; c++)if (a[c]) {
            var d = a[c].split("=");
            b[d[0]] = d[1]
        }
        return b
            ...
            if (a && a.url && (a = fb.simplelogin.util.misc.parseUrl(a.url), "/blank/page.html" === a.path)) {
                ...
                try {
                    var c = fb.simplelogin.util.misc.parseQuerystring(decodeURIComponent(a.hash)),
                        a = {}, i;
                    for (i in c)a[i] = fb.simplelogin.util.json.eval(c[i]);
                    b = a
                } catch (j) {
                }
                b && b.token && b.user ? d(null, b) : b && b.error ? d(b.error) : d({code: "UNKNOWN_ERROR", message: "An unknown error occurred."})
            }
        });
        e.addEventListener("exit", function () {
            d({code: "USER_DENIED", message: "User cancelled the authentication request."})
        });
        setTimeout(function () {
            e && e.close && e.close()
        }, popupTimeout)
    ...
    fb.simplelogin.transports.WinChan = function () {
        ...
        e = 8 <= f;
        return fb.simplelogin.util.json && fb.simplelogin.util.json.eval && fb.simplelogin.util.json.stringify && window.postMessage ? {open: function (f, g, h) {
            function m() {
            ...
            function l(a) {
                if (a.origin ===
                    r)try {
                    var b = fb.simplelogin.util.json.eval(a.data);
                    "ready" === b.a ? p.postMessage(x, r) : "error" === b.a ? (m(), h && (h(b.d), h = null)) : "response" === b.a && (m(), h && (h(null, b.d), h = null))
                } catch (c) {
                }
            }
            ...
            g.url = f;
            var o;
            g.url || (o = "missing required 'url' parameter");
            g.relay_url || (o = "missing required 'relay_url' parameter");
            o && setTimeout(function () {
                h(o)
            }, 0);
            g.window_name || (g.window_name = null);
            if (!(f = !g.window_features))a:{
                try {
                    var q = navigator.userAgent, f = -1 != q.indexOf("Fennec/") ||
                        -1 != q.indexOf("Firefox/") && -1 != q.indexOf("Android");
                    break a
                } catch (u) {
                }
                f = !1
            }
            f && (g.window_features = void 0);
            var n, r = c(g.url);
            if (r !== c(g.relay_url))return setTimeout(function () {
                h("invalid arguments: origin of url and relay_url must match")
            }, 0);
            var p;
            e && (n = document.createElement("iframe"), n.setAttribute("src", g.relay_url), n.style.display = "none", n.setAttribute("name", "__winchan_relay_frame"), document.body.appendChild(n), p = n.contentWindow);
            var v = window.open(g.url, g.window_name, g.window_features);
            p || (p = v);
            var w = setInterval(function () {
                if (v && v.closed) {
                    m();
                    if (h) {
                        h("unknown closed window");
                        h = null
                    }
                }
            }, 500), x = fb.simplelogin.util.json.stringify({a: "request", d: g.params});
            a(window, "unload", m);
            a(window, "message", l);
            return{close: m, focus: function () {
                if (v)try {
                    v.focus()
                } catch (a) {
                }
            ...
            function f(a) {
                ...
                e ? p.doPost(a, l) : p.postMessage(a, l)
            }

            function g(a) {
                var d;
                try {
                    d = fb.simplelogin.util.json.eval(a.data)
                } catch (e) {
                }
                d && "request" === d.a && (b(window, "message", g), l = a.origin,
    ...
    fb.simplelogin.transports.TriggerIoTab_.prototype.open = function (a, b, c) {
        ...
        forge.tabs.openWithOptions({url: a + "&transport=internal-redirect-hash", pattern: fb.simplelogin.Vars.getApiHost() + "/blank/page*"}, function (a) {
            var b;
            if (a && a.url)try {
                var c = fb.simplelogin.util.misc.parseUrl(a.url), h = fb.simplelogin.util.misc.parseQuerystring(decodeURIComponent(c.hash)), a = {}, i;
                for (i in h)a[i] =
                    fb.simplelogin.util.json.eval(h[i]);
                b = a
            } catch (j) {
            }
            b && b.token && b.user ? d(null, b) : b && b.error ? d(b.error) : d({code: "UNKNOWN_ERROR", message: "An unknown error occurred."})
        }, function () {
            d({code: "UNKNOWN_ERROR", message: "An unknown error occurred."})
        })
    };
    ...
    sjcl.cipher.aes.prototype = {encrypt: function (a) {
        ...
        var a = this.h[0], b = this.h[1], c = a[4], d = b[4], e, f, g, h = [], i = [], j, k, m, l;
        for (e = 0; e < 256; e++)i[(h[e] = e << 1 ^ (e >> 7) * 283) ^ e] = e;
        for (f = g = 0; !c[f]; f = f ^ (j || 1), g = i[g] || 1) {
            m = g ^ g << 1 ^ g << 2 ^ g << 3 ^ g << 4;
            m = m >> 8 ^ m & 255 ^ 99;
            c[f] = m;
            d[m] = f;
            k = h[e = h[j = h[f]]];
            l = k * 16843009 ^ e * 65537 ^ j * 257 ^ f * 16843008;
            k = h[m] * 257 ^ m * 16843008;
            for (e = 0; e < 4; e++) {
                a[e][f] = k = k << 24 ^ k >>> 8;
                b[e][m] = l = l << 24 ^ l >>> 8
            }
        ...
        var c = this.a[b], d = a[0] ^ c[0], e = a[b ? 3 : 1] ^ c[1], f = a[2] ^ c[2], a = a[b ? 1 : 3] ^ c[3], g, h, i, j = c.length / 4 - 2, k, m = 4, l = [0, 0, 0, 0];
        g = this.h[b];
        var o = g[0], q = g[1], u = g[2], n = g[3], r = g[4];
        for (k = 0; k < j; k++) {
            g = o[d >>> 24] ^ q[e >> 16 & 255] ^ u[f >> 8 & 255] ^ n[a & 255] ^ c[m];
            h = o[e >>> 24] ^ q[f >> 16 & 255] ^ u[a >> 8 & 255] ^ n[d & 255] ^ c[m + 1];
            i = o[f >>> 24] ^ q[a >> 16 & 255] ^ u[d >> 8 & 255] ^ n[e & 255] ^ c[m + 2];
            a = o[a >>> 24] ^ q[d >> 16 & 255] ^
                u[e >> 8 & 255] ^ n[f & 255] ^ c[m + 3];
            m = m + 4;
            d = g;
            e = h;
            f = i
        ...
        for (k = 0; k < 4; k++) {
            l[b ? 3 & -k : k] = r[d >>> 24] << 24 ^ r[e >> 16 & 255] << 16 ^ r[f >> 8 & 255] << 8 ^ r[a & 255] ^ c[m++];
            g = d;
            d = e;
            e = f;
            f = a;
    ...
    sjcl.hash.sha256.prototype = {blockSize: 512, reset: function () {
        ...
        for (var b, c, d = a.slice(0), e = this.m, f = this.a, g = e[0], h = e[1], i = e[2], j = e[3], k = e[4], m = e[5], l = e[6], o = e[7], a = 0; a < 64; a++) {
            if (a < 16)b = d[a]; else {
                b = d[a + 1 & 15];
                c = d[a + 14 & 15];
                b = d[a & 15] = (b >>> 7 ^ b >>> 18 ^
            ...
            b = b + o + (k >>> 6 ^ k >>> 11 ^ k >>> 25 ^ k << 26 ^ k << 21 ^ k << 7) + (l ^ k & (m ^ l)) + f[a];
            o = l;
            l = m;
            m = k;
            k = j + b | 0;
            ...
            i = h;
            h = g;
            g = b + (h & i ^ j & (h ^ i)) + (h >>> 2 ^ h >>> 13 ^ h >>> 22 ^ h << 30 ^ h << 19 ^ h << 10) | 0
        }
        e[0] = e[0] + g | 0;
        e[1] = e[1] + h | 0;
        e[2] = e[2] + i | 0;
    ...
    sjcl.mode.ccm = {name: "ccm", encrypt: function (a, b, c, d, e) {
        var f, g = b.slice(0), h = sjcl.bitArray, i = h.bitLength(c) / 8, j = h.bitLength(g) / 8, e = e || 64, d = d || [];
        ...
        var e = e || 64, d = d || [], f = sjcl.bitArray, g = f.bitLength(c) / 8, h = f.bitLength(b), i = f.clamp(b, h - e), j = f.bitSlice(b,
                h - e), h = (h - e) / 8;
        if (g < 7)throw new sjcl.exception.invalid("ccm: iv must be at least 7 bytes");
        for (b = 2; b < 4 && h >>> 8 * b; b++);
        b < 15 - g && (b = 15 - g);
        c = f.clamp(c, 8 * (15 - b));
        i = sjcl.mode.ccm.H(a, i, c, j, e, b);
        ...
        g = h.O;
        var i = b.length, j = h.bitLength(b), c = h.concat([h.partial(8,
    ...
    sjcl.misc.pbkdf2 = function (a, b, c, d, e) {
        ...
        typeof a === "string" && (a = sjcl.codec.utf8String.toBits(a));
        var e = e || sjcl.misc.hmac, a = new e(a), f, g, h, i, j = [], k = sjcl.bitArray;
        for (i = 1; 32 * j.length < (d || 1); i++) {
            e = f = a.encrypt(k.concat(b, [i]));
            for (g = 1; g < c; g++) {
                f = a.encrypt(f);
    ...
    fb.simplelogin.util.env.hasLocalStorage = function () {
        try {
            if (localStorage) {
    ...
    fb.simplelogin.util.env.hasSessionStorage = function () {
        try {
            if (sessionStorage) {
                sessionStorage.setItem("firebase-sentinel", "test");
                var a = sessionStorage.getItem("firebase-sentinel");
    ...
    goog.string.compareVersions = function (a, b) {
        for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
            ...
            do {
                ...
                var c = 0 == m[1].length ? 0 : parseInt(m[1], 10), o = 0 == l[1].length ? 0 : parseInt(l[1], 10), c = goog.string.compareElements_(c, o) || goog.string.compareElements_(0 ==
    ...
    goog.events.Listener.prototype.init = function (a, b, c, d, e, f) {
        if (goog.isFunction(a))this.isFunctionListener_ = !0; else if (a && a.handleEvent && goog.isFunction(a.handleEvent))this.isFunctionListener_ = !1; else throw Error("Invalid listener argument");
        this.listener = a;
        this.proxy = b;
        this.src = c;
        this.type = d;
    ...
    goog.events.BrowserFeature = {HAS_W3C_BUTTON: !goog.userAgent.IE || goog.userAgent.isDocumentMode(9), HAS_W3C_EVENT_SUPPORT: !goog.userAgent.IE || goog.userAgent.isDocumentMode(9), SET_KEY_CODE_TO_PREVENT_DEFAULT: goog.userAgent.IE && !goog.userAgent.isVersion("8"), HAS_NAVIGATOR_ONLINE_PROPERTY: !goog.userAgent.WEBKIT || goog.userAgent.isVersion("528"), HAS_HTML5_NETWORK_EVENT_SUPPORT: goog.userAgent.GECKO && goog.userAgent.isVersion("1.9b") || goog.userAgent.IE && goog.userAgent.isVersion("8") || goog.userAgent.OPERA && goog.userAgent.isVersion("9.5") ||
        goog.userAgent.WEBKIT && goog.userAgent.isVersion("528"), HTML5_NETWORK_EVENTS_FIRE_ON_BODY: goog.userAgent.GECKO && !goog.userAgent.isVersion("8") || goog.userAgent.IE && !goog.userAgent.isVersion("9")};
    ...
    goog.debug.entryPointRegistry.unmonitorAllIfPossible = function (a) {
        ...
        for (var a = goog.bind(a.unwrap, a), c = 0; c < goog.debug.entryPointRegistry.refList_.length; c++)goog.debug.entryPointRegistry.refList_[c](a);
        b.length--
    };
    ...
    goog.events.EventType = {CLICK: "click", DBLCLICK: "dblclick", MOUSEDOWN: "mousedown", MOUSEUP: "mouseup", MOUSEOVER: "mouseover", MOUSEOUT: "mouseout", MOUSEMOVE: "mousemove", SELECTSTART: "selectstart", KEYPRESS: "keypress", KEYDOWN: "keydown", KEYUP: "keyup", BLUR: "blur", FOCUS: "focus", DEACTIVATE: "deactivate", FOCUSIN: goog.userAgent.IE ? "focusin" : "DOMFocusIn", FOCUSOUT: goog.userAgent.IE ? "focusout" : "DOMFocusOut", CHANGE: "change", SELECT: "select", SUBMIT: "submit", INPUT: "input", PROPERTYCHANGE: "propertychange", DRAGSTART: "dragstart",
        ...
        BEFOREPASTE: "beforepaste", ONLINE: "online", OFFLINE: "offline", MESSAGE: "message", CONNECT: "connect", TRANSITIONEND: goog.userAgent.WEBKIT ? "webkitTransitionEnd" : goog.userAgent.OPERA ? "oTransitionEnd" : "transitionend"};
    goog.disposable = {};
    ...
    goog.Disposable.prototype.dispose = function () {
        if (!this.disposed_) {
            if (goog.Disposable.ENABLE_MONITORING) {
                if (void 0 == this.disposed_)throw Error(this + " did not call the goog.Disposable base constructor");
    ...
    goog.events.unlisten = function (a, b, c, d, e) {
        ...
        if (!a)return!1;
        for (f = 0; f < a.length; f++)if (a[f].listener == c && a[f].capture == d && a[f].handler == e)return goog.events.unlistenByKey(a[f].key);
        return!1
    };
    ...
    goog.events.removeAll = function (a, b, c) {
        ...
        }); else if (a = goog.getUid(a), goog.events.sources_[a])for (var a = goog.events.sources_[a], g = a.length - 1; 0 <= g; g--) {
            var h = a[g];
            if ((e || b == h.type) && (f || c == h.capture))goog.events.unlistenByKey(h.key), d++
        }
        return d
    ...
    goog.events.dispatchEvent = function (a, b) {
        ...
        if (!1 in d)if (g = d[!1], g.remaining_ = g.count_, c)for (h = 0; !b.propagationStopped_ && h < f.length && g.remaining_; h++)b.currentTarget = f[h], e &= goog.events.fireListeners_(g, f[h], b.type, !1, b) && !1 != b.returnValue_; else for (d = a; !b.propagationStopped_ && d && g.remaining_; d = d.getParentEventTarget())b.currentTarget = d, e &= goog.events.fireListeners_(g, d, b.type, !1, b) && !1 != b.returnValue_;
        return Boolean(e)
    };
    ...
    goog.events.handleBrowserEvent_ = function (a, b) {
        ...
        if (!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
            ...
            try {
                if (h) {
                    for (var k = [], m = j.currentTarget; m; m = m.parentNode)k.push(m);
                    g = e[!0];
                    g.remaining_ = g.count_;
                    for (var l = k.length - 1; !j.propagationStopped_ && 0 <= l && g.remaining_; l--)j.currentTarget = k[l], f &= goog.events.fireListeners_(g, k[l], d, !0, j);
                    if (i) {
                        g = e[!1];
                        g.remaining_ = g.count_;
    ...
    goog.net.DefaultXmlHttpFactory.prototype.getProgId_ = function () {
        if (goog.net.XmlHttp.ASSUME_NATIVE_XHR)return"";
        ...
        var c = new goog.structs.Set, d = [], e = function (a, g) {
            ...
            try {
                if (goog.isDef(a))if (goog.isNull(a))d.push("NULL"); else if (goog.isString(a))d.push('"' + a.replace(/\n/g, "\n" + g) + '"'); else if (goog.isFunction(a))d.push(String(a).replace(/\n/g, "\n" + g)); else if (goog.isObject(a))if (c.contains(a))d.push("*** reference loop detected ***"); else {
                    c.add(a);
                    d.push("{");
                    for (var i in a)if (b || !goog.isFunction(a[i]))d.push("\n"), d.push(h), d.push(i + " = "), e(a[i], h);
                    d.push("\n" + g + "}")
                } else d.push(a);
    ...
    goog.debug.normalizeErrorObject = function (a) {
        ...
        return e || !a.lineNumber || !a.fileName || !a.stack ? {message: a.message, name: a.name, lineNumber: c, fileName: d, stack: a.stack || "Not available"} :
            a
    };
    ...
    goog.debug.Logger.prototype.setLevel = function (a) {
        if (goog.debug.Logger.ENABLE_HIERARCHY)this.level_ = a; else {
    ...
    goog.net.XhrIo.prototype.send = function (a, b, c, d) {
        if (this.xhr_)throw Error("[goog.net.XhrIo] Object is active with another request");
        ...
        try {
            this.logger_.fine(this.formatMsg_("Opening Xhr")),
                this.inOpen_ = !0, this.xhr_.open(b, a, !0), this.inOpen_ = !1
        } catch (e) {
        ...
        try {
            this.timeoutId_ && (goog.Timer.defaultTimerObject.clearTimeout(this.timeoutId_), this.timeoutId_ = null), 0 < this.timeoutInterval_ && (this.logger_.fine(this.formatMsg_("Will abort after " + this.timeoutInterval_ + "ms if incomplete")), this.timeoutId_ = goog.Timer.defaultTimerObject.setTimeout(goog.bind(this.timeout_, this), this.timeoutInterval_)), this.logger_.fine(this.formatMsg_("Sending request")),
                this.inSend_ = !0, this.xhr_.send(a), this.inSend_ = !1
        } catch (g) {
    ...
    goog.net.XhrIo.prototype.getResponse = function () {
        try {
            ...
            return this.logger_.fine("Can not get response: " +
                a.message), null
        }
    };
    ...
    fb.simplelogin.transports.XHR_.prototype.open = function (a, b, c) {
        var d = this, e = new goog.net.XhrIo;
        goog.events.listen(e, "complete", function () {
            if (e.isSuccess()) {
                var a = e.getResponseJson(), b = a.error || null;
                delete a.error;
                c && c(b, a)
            } else c && c(d.formatError_({code: "SERVER_ERROR", message: "An unknown server error occurred."}))
        });
        var a = a + "?", f;
        for (f in b)a += "&" + encodeURIComponent(f) + "=" + encodeURIComponent(b[f]);
        e.send(a, "GET", null, {"content-type": "application/json"})
    };
    ...
    fb.simplelogin.util.validation.validateNamespace = function (a, b, c, d) {
        if ((!d || goog.isDef(c)) && !goog.isString(c))throw Error(fb.simplelogin.util.validation.errorPrefix_(a, b, d) + "must be a valid firebase namespace.");
    };
    fb.simplelogin.util.validation.validateCallback = function (a, b, c, d) {
        if ((!d || goog.isDef(c)) && !goog.isFunction(c))throw Error(fb.simplelogin.util.validation.errorPrefix_(a, b, d) + "must be a valid function.");
    };
    fb.simplelogin.util.validation.validateString = function (a, b, c, d) {
        if ((!d || goog.isDef(c)) && !goog.isString(c))throw Error(fb.simplelogin.util.validation.errorPrefix_(a, b, d) + "must be a valid string.");
    };
    fb.simplelogin.util.validation.validateContextObject = function (a, b, c, d) {
        if (!d || goog.isDef(c))if (!goog.isObject(c) || null === c)throw Error(fb.simplelogin.util.validation.errorPrefix_(a, b, d) + "must be a valid context object.");
    };
    ...
    fb.simplelogin.transports.JSONP_.prototype.open = function (a, b, c) {
        var a = a + (/\?/.test(a) ? "" : "?"), a = a + "&transport=jsonp", d;
        for (d in b)a += "&" + encodeURIComponent(d) + "=" + encodeURIComponent(b[d]);
        ...
        setTimeout(function () {
            try {
                ...
                e.onerror = function () {
                    ...
                    c && c(d.formatError_({code: "SERVER_ERROR", message: "An unknown server error occurred."}))
                };
                var f = document.getElementsByTagName("script")[0];
                f.parentNode.insertBefore(e, f)
            } catch (g) {
                c && c(d.formatError_({code: "SERVER_ERROR",
    ...
    fb.simplelogin.providers.Password_.prototype.login = function (a, b) {
        ...
        if (!fb.simplelogin.util.validation.isValidNamespace(a.firebase))return b && b(fb.simplelogin.Errors.get("INVALID_FIREBASE"));
    ...
    fb.simplelogin.providers.Password_.prototype.createUser = function (a, b) {
        ...
        if (!fb.simplelogin.util.validation.isValidNamespace(a.firebase))return b && b(fb.simplelogin.Errors.get("INVALID_FIREBASE"));
        if (!fb.simplelogin.util.validation.isValidEmail(a.email))return b && b(fb.simplelogin.Errors.get("INVALID_EMAIL"));
        if (!fb.simplelogin.util.validation.isValidPassword(a.password))return b && b(fb.simplelogin.Errors.get("INVALID_PASSWORD"));
    ...
    fb.simplelogin.providers.Password_.prototype.changePassword = function (a, b) {
        ...
        if (!fb.simplelogin.util.validation.isValidNamespace(a.firebase))return b && b(fb.simplelogin.Errors.get("INVALID_FIREBASE"));
        if (!fb.simplelogin.util.validation.isValidEmail(a.email))return b && b(fb.simplelogin.Errors.get("INVALID_EMAIL"));
        if (!fb.simplelogin.util.validation.isValidPassword(a.newPassword))return b && b(fb.simplelogin.Errors.get("INVALID_PASSWORD"));
        this.getTransport_().open(c,
            a, b)
    };
    ...
    fb.simplelogin.transports.WindowsMetroAuthBroker_.prototype.open = function (a, b, c) {
        ...
        try {
            ...
            return c({code: "WINDOWS_METRO", message: '"Windows.Security.Authentication.Web.WebAuthenticationBroker" required when using Firebase Simple Login in Windows Metro context'})
        }
        h = !1;
        i = function () {
            var a = Array.prototype.slice.apply(arguments);
        ...
        g(e.none, a, d).done(function (a) {
                var b;
                if (a && a.responseData)try {
                    var c = fb.simplelogin.util.misc.parseUrl(a.responseData), d = fb.simplelogin.util.misc.parseQuerystring(decodeURIComponent(c.hash)), a = {}, e;
                    for (e in d)a[e] = fb.simplelogin.util.json.eval(d[e]);
                    b = a
                } catch (f) {
                }
                b && b.token && b.user ? i(null, b) : b && b.error ? i(b.error) : i({code: "UNKNOWN_ERROR", message: "An unknown error occurred."})
            },
            function () {
                i({code: "UNKNOWN_ERROR", message: "An unknown error occurred."})
            })
    };
    ...
    fb.simplelogin.providers.Persona_.prototype.login = function (a, b) {
        navigator.id.watch({onlogin: function (a) {
            b(a)
        }, onlogout: function () {
        }});
        a = a || {};
    ...
    goog.net.Cookies.prototype.containsValue = function (a) {
        for (var b = this.getKeyValues_().values, c = 0; c < b.length; c++)if (b[c] == a)return!0;
        return!1
    };
    ...
    goog.net.Cookies.prototype.getKeyValues_ = function () {
        for (var a = this.getParts_(), b = [], c = [], d, e, f = 0; e = a[f]; f++)d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
    ...
    fb.simplelogin.SessionStore_.prototype.get = function () {
        if (hasLocalStorage) {
            try {
                ...
                if (a && b)return fb.simplelogin.util.json.eval(sjcl.decrypt(a, fb.simplelogin.util.json.eval(b)))
            } catch (c) {
            }
            return null
        }
    ...
    fb.simplelogin.client = function (a, b, c, d) {
        ...
        window._FirebaseSimpleLogin.callbacks.push({cb: b, ctx: c});
        goog.isString(e) && (b = e.indexOf("//"), 0 <= b && (e = e.substring(b + 2)), b = e.indexOf("."), 0 <= b && (f = e.substring(0, b)));
        if (!goog.isString(f))throw Error("new FirebaseSimpleLogin(): First argument must be a valid Firebase reference (i.e. new Firebase(<firebaseURL>)).");
        ...
        this.mLoginStateChange = function () {
            for (var a = window._FirebaseSimpleLogin.callbacks || [], b = Array.prototype.slice.apply(arguments), c = 0; c < a.length; c++) {
                var d = a[c], e = !!b[0] || typeof d.user === "undefined";
                if (!e) {
                    var f, l;
                    if (d.user && d.user.firebaseAuthToken)f = d.user.firebaseAuthToken;
                    if (b[1] && b[1].firebaseAuthToken)l = b[1].firebaseAuthToken;
                    e = (f || l) && f !== l
                }
                window._FirebaseSimpleLogin.callbacks[c].user = b[1] || null;
                e &&
                function (a, c) {
    ...
    fb.simplelogin.client.prototype.resumeSession = function () {
        ...
        if (b) {
            ...
            d.open(fb.simplelogin.Vars.getApiHost() + "/auth/session", {requestId: b, firebase: a.mNamespace}, function (b, c) {
                if (c && c.token && c.user)a.attemptAuth(c.token, c.user, true); else if (b) {
                    fb.simplelogin.SessionStore.clear();
                    a.mLoginStateChange(b)
                } else {
                    fb.simplelogin.SessionStore.clear();
                    a.mLoginStateChange(null, null)
                }
            })
        } else(b = fb.simplelogin.SessionStore.get()) && b.token && b.user ? a.attemptAuth(b.token, b.user, !1) : a.mLoginStateChange(null, null)
    };
    fb.simplelogin.client.prototype.attemptAuth = function (a, b, c) {
        var d = this;
        this.mRef.auth(a, function (e, f) {
            e ? (fb.simplelogin.SessionStore.clear(), d.mLoginStateChange(null, null)) : (c && fb.simplelogin.SessionStore.set({token: a, user: b, sessionKey: b.sessionKey}, d.sessionLengthDays), "function" == typeof f && f(), delete b.sessionKey, b.firebaseAuthToken = a, d.mLoginStateChange(null, b))
        }, function () {
            fb.simplelogin.SessionStore.clear();
    ...
    fb.simplelogin.client.prototype.login = function () {
        fb.simplelogin.util.validation.validateString(c, 1, arguments[0], !1);
        var a = arguments[1] || {}, b = arguments[0].toLowerCase(), c = "FirebaseSimpleLogin.login(" + b + ")";
        if ("password" === b) {
            if (!fb.simplelogin.util.validation.isValidEmail(a.email))return this.mLoginStateChange(fb.simplelogin.Errors.get("INVALID_EMAIL"));
            if (!fb.simplelogin.util.validation.isValidPassword(a.password))return this.mLoginStateChange(fb.simplelogin.Errors.get("INVALID_PASSWORD"))
        } else("facebook" ===
            b || "github" === b || "google" === b || "persona" === b || "twitter" === b || "anonymous" === b) && fb.simplelogin.util.validation.validateArgCount(c, 1, 2, arguments.length);
        this.sessionLengthDays = a.rememberMe ? 30 : null;
        switch (b) {
            case "anonymous":
                return this.loginAnonymously(a);
            case "facebook-token":
                return this.loginWithFacebookToken(a);
            case "github":
                return this.loginWithGithub(a);
            case "google-token":
                return this.loginWithGoogleToken(a);
            case "password":
                return this.loginWithPassword(a);
            case "persona":
                return this.loginWithPersona(a);
            case "twitter-token":
                return this.loginWithTwitterToken(a);
            case "facebook":
                return a.access_token ? this.loginWithFacebookToken(a) : this.loginWithFacebook(a);
            case "google":
                return a.access_token ? this.loginWithGoogleToken(a) : this.loginWithGoogle(a);
            case "twitter":
                return a.oauth_token && a.oauth_token_secret ? this.loginWithTwitterToken(a) : this.loginWithTwitter(a);
            default:
    ...
    fb.simplelogin.client.prototype.loginWithPersona = function (a) {
        var b = this;
        if (!navigator.id)throw Error("FirebaseSimpleLogin.login(persona): Unable to find Persona include.js");
        fb.simplelogin.providers.Persona.login(a, function (a) {
            null === a ? callback(fb.simplelogin.Errors.get("UNKNOWN_ERROR")) : fb.simplelogin.transports.JSONP.open(fb.simplelogin.Vars.getApiHost() + "/auth/persona/token", {firebase: b.mNamespace, assertion: a}, function (a, c) {
                a || !c.token || !c.user ? b.mLoginStateChange(fb.simplelogin.Errors.format(a),
                    null) : b.attemptAuth(c.token, c.user, !0)
            })
        })
    };
    ...
    fb.simplelogin.client.prototype.loginViaToken = function (a, b) {
        var b = b || {}, c = this, d = fb.simplelogin.Vars.getApiHost() + "/auth/" + a + "/token?firebase=" + c.mNamespace;
        fb.simplelogin.transports.JSONP.open(d, b, function (a, b) {
            a || !b.token || !b.user ? c.mLoginStateChange(fb.simplelogin.Errors.format(a), null) : c.attemptAuth(b.token, b.user, !0)
        })
    };
    fb.simplelogin.client.prototype.loginViaOAuth = function (a, b) {
        var b = b || {}, c = this, d = fb.simplelogin.Vars.getApiHost() + "/auth/" + a + "?firebase=" + this.mNamespace;
        b.scope && (d += "&scope=" + b.scope);
        b.debug && (d += "&debug=" + b.debug);
        ...
        var f = fb.simplelogin.util.env.isMobileCordovaInAppBrowser() ? "mobile-phonegap" : fb.simplelogin.util.env.isMobileTriggerIoTab() ?
            "mobile-triggerio" : fb.simplelogin.util.env.isWindowsMetro() ? "windows-metro" : "desktop", g;
        if ("desktop" === f) {
            g = "WinChan";
            var f = [], h;
            ...
            b.window_features = f.join(",")
        } else"mobile-phonegap" === f ? g = "CordovaInAppBrowser" : "mobile-triggerio" === f ? g = "TriggerIoTab" : "windows-metro" === f && (g = "WindowsMetroAuthBroker");
        if (b.preferRedirect || fb.simplelogin.util.env.isChromeiOS() || fb.simplelogin.util.env.isWindowsPhone() ||
            fb.simplelogin.util.env.isStandaloneiOS() || fb.simplelogin.util.env.isTwitteriOS() || fb.simplelogin.util.env.isFacebookiOS()) {
            e = goog.string.getRandomString() + goog.string.getRandomString();
            try {
                sessionStorage.setItem("firebaserequestId", e)
            } catch (i) {
            }
            d += "&requestId=" + e + "&fb_redirect_uri=" + encodeURIComponent(window.location.href);
            return window.location = d
        }
        fb.simplelogin.transports[g].open(d, b, function (a, b) {
            if (b && b.token && b.user)c.attemptAuth(b.token, b.user, true); else {
                var d = a || {code: "UNKNOWN_ERROR", message: "An unknown error occurred."};
                if (a === "unknown closed window")d = {code: "USER_DENIED", message: "User cancelled the authentication request."}; else if (b && b.error)d = b.error;
                c.mLoginStateChange(fb.simplelogin.Errors.format(d), null)
            }
        })
    };
    ...
    fb.simplelogin.client.prototype.createUser = function (a, b, c) {
        this.manageFirebaseUsers("createUser", {email: a, password: b}, c)
    };
    ...
    fb.simplelogin.client.prototype.changePassword = function (a, b, c, d) {
        this.manageFirebaseUsers("changePassword", {email: a, oldPassword: b, newPassword: c}, function (a) {
            return d && d(a)
        })
    };
    ...
    fb.simplelogin.client.prototype.removeUser = function (a, b, c) {
        this.manageFirebaseUsers("removeUser", {email: a, password: b}, function (a) {
            return c && c(a)
        })
    };
    ...
    var FirebaseSimpleLogin = function (a, b, c, d) {
        ...
        if (goog.isString(a))throw Error("new FirebaseSimpleLogin(): Oops, it looks like you passed a string instead of a Firebase reference (i.e. new Firebase(<firebaseURL>)).");
        var e = new fb.simplelogin.client(a, b, c, d);
        return{setApiHost: function (a) {
            fb.simplelogin.util.validation.validateArgCount("FirebaseSimpleLogin.setApiHost",
                1, 1, arguments.length);
            e.setApiHost(a)
        }, login: function () {
            e.login.apply(e, arguments)
        }, logout: function () {
            ...
            fb.simplelogin.util.validation.validateArgCount("FirebaseSimpleLogin.changePassword",
                4, 4, arguments.length);
            fb.simplelogin.util.validation.validateCallback("FirebaseSimpleLogin.changePassword", 4, d, !1);
            e.changePassword(a, b, c, d)
            ...
            fb.simplelogin.util.validation.validateArgCount("FirebaseSimpleLogin.sendPasswordResetEmail",
                2, 2, arguments.length);
            fb.simplelogin.util.validation.validateCallback("FirebaseSimpleLogin.sendPasswordResetEmail", 2, b, !1);
            e.sendPasswordResetEmail(a, b)
        }}
    };
